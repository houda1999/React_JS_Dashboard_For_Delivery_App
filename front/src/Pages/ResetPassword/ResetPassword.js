    ...
    useEffect(() => {
        ...
        if (!parametrs) {
            ...
            if (expiration < now) {
                ...
                navigate.push(`/resetPassword/${id}/${token}`);
                setParametrs(true);
            }
        }
                            ...
                            <div className="row">
                                {submitted ? (
                                    ...
                                    <div className="col-md-9 col-lg-8 mx-auto">
                                        ...
                                        <form onSubmit={Save}>
                                            <div className="form-floating mb-3 div-input-resetPass"
                                                onMouseLeave={(e) => setShowEye1(false)}
                                                onMouseEnter={(e) => { if (password.trim() != "") setShowEye1(true) }}>
                                                <input
                                                    type={type1}
                                                    id="floatingPassword"
                                                    className="form-control passInput resetPassInput"
                                            ...
                                            <div className="form-floating mb-3 div-input-resetPass" onMouseLeave={(e) => setShowEye2(false)}
